...
<body id="page-top">
  ...
  <div class="container">
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-condensed" id="formation" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>Id</th>
                      <th>description</th>
                      <th>responsable</th>
                      <th>personnes convoquées</th>
                      <th>personnes presentes</th>
                      <th>dossier/actions</th>
                    </tr>
                  </thead>
                </table>
              </div>
...
<div class="modal fade" id="modalformation" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <form id="form1">    
            <div class="modal-body">
                ...
                <div class="row"> 
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">personnes convoquées</label>
                    <input type="text" class="form-control" id="nom3">
                    </div>               
                    </div>
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">personnes presente</label>
