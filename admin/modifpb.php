...
if (empty($_SESSION['id']) ){
  ...
  exit();
     ...
     $req=$bdd->query('select * from bp where id='.$m);
         $donnee=$req->fetch(); 
      }
...
include('connection.php');
$req=$bdd->prepare('update bp set responsable=? where id='.$m);
$req->execute(array($description));
header('location:Tbp.php');
}     
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="row">
          <div class="col-lg-8">
            <div class="p-5">
              ...
              <form class="user" action="modifpb.php" method="post">
